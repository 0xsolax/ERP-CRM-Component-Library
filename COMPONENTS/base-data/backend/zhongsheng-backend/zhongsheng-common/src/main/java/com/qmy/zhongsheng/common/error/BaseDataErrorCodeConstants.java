...
public final class BaseDataErrorCodeConstants {
    ...
    public static final ErrorCode BASE_DATA_TREE_NODE_DATA_NOT_UPDATE = new ErrorCode(40034, "该树节点数据不允许被编辑");

    public static final ErrorCode BASE_DATA_VALUE1_DUPLICATE = new ErrorCode(40035, "数据已存在");
}
