...
public class BaseTreeNodeDO extends BaseDO {
    ...
    /**
     * 业务类型，与 {@link com.qmy.zhongsheng.common.enums.BaseTreeBizTypeEnum#getValue()} 一致的大写英文。
     */
    @TableField("biz_type")
     ...
     * 当业务类型 {@link com.qmy.zhongsheng.common.enums.BaseTreeBizTypeEnum#isLeafOnlyDataBind()} 为 true 时，仅叶子节点可为 1。
     */
