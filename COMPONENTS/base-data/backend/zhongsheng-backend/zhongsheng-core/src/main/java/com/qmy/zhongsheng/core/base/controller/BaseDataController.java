package com.qmy.zhongsheng.core.base.controller;

import com.qmy.zhongsheng.api.dto.base.BaseDataListQueryDTO;
import com.qmy.zhongsheng.api.dto.base.BaseDataQueryByNodeKeyDTO;
import com.qmy.zhongsheng.api.dto.base.BaseDataSaveDTO;
import com.qmy.zhongsheng.api.dto.base.BaseTreeNodeListQueryDTO;
...
public class BaseDataController {
     ...
     */
    @PostMapping("/delete")
    @PreAuthorize("@ss.hasPermission(@ss.perm('BASE_DATA_DELETE'))")
     ...
     */
    @PostMapping("/list")
    @PreAuthorize("@ss.hasPermission(@ss.perm('BASE_DATA_LIST'))")
    ...
    @PreAuthorize("@ss.hasPermission(@ss.perm('BASE_DATA_LIST_BY_NODE_KEY'))")
    ...
    @PreAuthorize("@ss.hasPermission(@ss.perm('BASE_DATA_TREE_NODE_LIST'))")
    ...
    public ResultInfo<List<BaseTreeNodeVO>> treeNodeList(@RequestBody(required = false) BaseTreeNodeListQueryDTO query) {
        ...
        String nodeKey =  query != null ? query.getNodeKey() : null;
        return ResultInfo.success(baseDataService.listNodeByBizTypeOrNodeKey(bizType, nodeKey));
    }
}
