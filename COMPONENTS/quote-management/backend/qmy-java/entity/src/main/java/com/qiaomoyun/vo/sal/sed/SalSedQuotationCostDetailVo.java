...
@Data
public class SalSedQuotationCostDetailVo {
    @Schema(description = "配件明细")
    private List<SalSedQuotationFittingDetailVo> fittingDetail;
    @Schema(description = "配件总成本")
    private BigDecimal fittingCost;
    ...
    private BigDecimal effectCost;

    @Schema(description = "包材明细")
    private List<SalSedQuotationPackagingDetailVo> packagingDetail;
