<template>
  <el-dialog v-model="dialogVisible" title="追加2" width="500px" @close="onDestroy">
...
const { onDestroy, callback, productCode, specName, supplierId, supplier, rowData } = attrs as any
