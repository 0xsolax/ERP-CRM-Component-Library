...
const permissionRouter: Array<RouteRecordRaw> = [
  ...
  //     {
  //       path: '/system/role',
  //       component: () => import('@/views/zs/system/role/index.vue'),
  //       name: 'system-role',
  //       meta: {
  //         title: '角色管理',
  //         icon: 'Female',
  ...
  //           component: () => import('@/views/zs/system/role/add.vue'),
  ...
  //     {
  //       path: '/system/org',
  //       component: () => import('@/views/zs/system/org/index.vue'),
  //       name: 'system-org',
  //       meta: {
  //         title: '组织架构',
  //         icon: 'User',
  ...
  //           component: () => import('@/views/zs/system/org/add.vue'),
  ...
  //     // {
  //     //   path: '/system/menu',
  //     //   component: () => import('@/views/zs/system/menu/index.vue'),
  //     //   name: 'system-menu',
  //     //   meta: {
  //     //     title: '菜单管理',
  //     //     icon: 'Menu'
