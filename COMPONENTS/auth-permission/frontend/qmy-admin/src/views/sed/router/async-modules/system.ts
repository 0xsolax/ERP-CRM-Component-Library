...
const permissionRouter: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      {
        path: '/system/role',
        component: () => import('@/views/sed/system/role/index.vue'),
        name: 'system-role',
        meta: {
          title: '角色管理',
          icon: 'Female',
        ...
        children: [
          {
            ...
            component: () => import('@/views/sed/system/role/add.vue'),
      ...
      {
        path: '/system/org',
        component: () => import('@/views/sed/system/org/index.vue'),
        name: 'system-org',
        meta: {
          title: '组织架构',
          icon: 'User',
        ...
        children: [
          {
            ...
            component: () => import('@/views/sed/system/org/add.vue'),
      ...
      // {
      //   path: '/system/menu',
      //   component: () => import('@/views/sed/system/menu/index.vue'),
      //   name: 'system-menu',
      //   meta: {
      //     title: '菜单管理',
      //     icon: 'Menu'
