...
<script lang="ts" setup name="sales-customer">
...
import { getCustomerList, deleteCustomer } from '@/api/admin/sales/customer'
...
onBeforeRouteLeave(to => {
  if (!to.path.startsWith('/sales/customer')) {
    tagsStore.delCachedView('sales-customer')
  }
})
...
const columns: ColumnProps[] = [
  ...
  },
  {
    ...
    align: 'center',
    render: ({ row }) => {
      return getCustomerTypeLabel(row.type)
    }
  },
  {
    label: '手动层级',
