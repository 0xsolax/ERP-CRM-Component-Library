  ...
  <el-dialog v-model="visible" title="联系人" width="800px" @close="handleClose">
    <div class="contact-list-content">
      <div class="list-header">
        <el-button type="primary" size="small" @click="handleAdd" v-permission="'sal:yt:customer:updateContactPerson'">
          新增
        </el-button>
      </div>
...
import { getCustomerDetail } from '@/api/sed/sales/customer'
