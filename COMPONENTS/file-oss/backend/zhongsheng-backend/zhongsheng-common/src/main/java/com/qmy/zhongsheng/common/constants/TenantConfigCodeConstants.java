...
public final class TenantConfigCodeConstants {
    ...
    /** OSS STS 调用 AssumeRole 使用的 AccessKey（与机器翻译 AK 分离） */
    ...
    /** 是否启用阿里云机器翻译（未命中词库时调用），如 true/false、1/0 */
    public static final String TRANSLATION_ALIYUN_ENABLED = "tenant.translation.aliyun-enabled";
    /** 机器翻译 HTTP 接口完整 URL */
    public static final String TRANSLATION_SERVICE_URL = "tenant.translation.service-url";
    /** 机器翻译 ROA 签名使用的 AccessKey（与 OSS STS 分离） */
    public static final String TRANSLATION_ACCESS_KEY_ID = "tenant.translation.access-key-id";
    public static final String TRANSLATION_ACCESS_KEY_SECRET = "tenant.translation.access-key-secret";
    ...
    /**
     * 机器翻译场景需要拉取的 config_code（开关、URL、翻译专用 AK）。
     */
    public static List<String> getTenantTranslationAliyunCodes() {
        return List.of(
                TRANSLATION_ALIYUN_ENABLED,
                TRANSLATION_SERVICE_URL,
                TRANSLATION_ACCESS_KEY_ID,
                TRANSLATION_ACCESS_KEY_SECRET
        );
    }
}
