...
/**
 * @author AI Coding
 * @description TenantConfigCodeEnum
...
public enum TenantConfigCodeEnum {
    ...
    OSS_ACCESS_KEY_ID(TenantConfigCodeConstants.OSS_ACCESS_KEY_ID, "OSS AccessKeyId", "OSS STS AssumeRole 使用的 AccessKeyId（与翻译 AK 分离）", ""),
    OSS_ACCESS_KEY_SECRET(TenantConfigCodeConstants.OSS_ACCESS_KEY_SECRET, "OSS AccessKeySecret", "OSS STS AssumeRole 使用的 AccessKeySecret", ""),
    ...
    TRANSLATION_ALIYUN_ENABLED(TenantConfigCodeConstants.TRANSLATION_ALIYUN_ENABLED, "机器翻译开关", "是否启用阿里云机器翻译（未命中词库时调用），如 true / false", "false"),
    TRANSLATION_SERVICE_URL(TenantConfigCodeConstants.TRANSLATION_SERVICE_URL, "机器翻译接口 URL", "阿里云机器翻译 HTTP 完整地址；默认通用版 …/general，电商版 …/ecommerce", "http://mt.cn-hangzhou.aliyuncs.com/api/translate/web/general"),
    TRANSLATION_ACCESS_KEY_ID(TenantConfigCodeConstants.TRANSLATION_ACCESS_KEY_ID, "机器翻译 AccessKeyId", "机器翻译 ROA 调用使用的 AccessKeyId（与 OSS STS 分离）", ""),
    TRANSLATION_ACCESS_KEY_SECRET(TenantConfigCodeConstants.TRANSLATION_ACCESS_KEY_SECRET, "机器翻译 AccessKeySecret", "机器翻译 ROA 调用使用的 AccessKeySecret", "");
